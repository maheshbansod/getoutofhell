...
int main() {
  ...
  usleep(DELAY_USEC*2);
  printf("\033[33m\"%s, I'm not your buddy. You didn't accept my cookies the last time we met. I'm gonna kill you,\" Light smiles\033[39m\n");
  usleep(DELAY_USEC*4);
  ...
  do {
    ...
    if(turn >= 7) {
      printf("That is the perfect answer, %s!\n", name);
      usleep(DELAY_USEC*2);
    ...
    printf("Do you want to play again(1: no/ 0: yes)? ");
    scanf("%d", &quit);
